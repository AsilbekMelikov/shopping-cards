  ...
  return (
    <div className="card" id={id}>
      ...
      <div className="card-content">
        ...
        <p>
          <b>Rate of fire:</b> {rof}
        </p>
        <p>
          <b>Reload time:</b> {reload_time}
        </p>
        <p>
          <b>Counter part:</b> {counter_part}
        </p>
        <p>
          <b>Movement speed:</b> {movement_speed}
        </p>
        <p>
          <b>Kill award:</b> {kill_award}
        </p>
        <p>
          <b>Accurate range:</b> {accurate_range}
        </p>
      </div>
      <div className="card-action">
        <ChangeButton id={id} name={name} price={price} />
